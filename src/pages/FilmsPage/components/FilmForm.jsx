      ...
      <div className="ui  grid mb-3">
          ...
          <div className="ten wide column">
            ...
            <div className={`field img-grid ${errors.img ? "error" : ""}`}>
              ...
              <input
                ...
                id="img"
              />
              {errors.img && <FormMessage type="error">{errors.img}</FormMessage>}
        ...
        <div className="three column row mb-3">
          ...
          <div className={`column field ${errors.director ? "error" : ""}`}>
            ...
            />
            {errors.director && <FormMessage type="error">{errors.director}</FormMessage>}
          </div>
          {/* director END */}
          {/* duration START */}
          <div className={`column field ${errors.duration ? "error" : ""}`}>
            ...
            />
            {errors.duration && <FormMessage type="error">{errors.duration}</FormMessage>}
          </div>
          {/* duration END */}
          ...
          <div className={`column field ${errors.price ? "error" : ""}`}>
            ...
            <input
              ...
              placeholder="price"
            />
            {errors.price && <FormMessage type="error">{errors.price}</FormMessage>}
          </div>
          {/* price END */}
        </div>
        {/* three columns END */}
